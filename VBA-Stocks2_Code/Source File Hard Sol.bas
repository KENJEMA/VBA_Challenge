...
'Color code yearly change
    ...
    'model cells according to assignment
    ...
    'Find max and min values in column "Percent Change" and the max value in "Total Stock Volume"
    
    'Then refrence the ticker name, and the corresponding values to the percent change and total volume of stock for that ticker
